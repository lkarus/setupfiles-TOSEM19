...
if [ ! -d "$D4J_HOME" ]; then
  git clone 'https://github.com/yunho-kim/defects4j.git' "$HERE/defects4j" || die 'unable to clone Defects4J'
  # cp ../init.sh defects4j/init.sh || die "there is an error here"
